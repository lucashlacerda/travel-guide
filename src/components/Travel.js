...
export default function Travel(props){
   return (
    <div className="card">
       <img className="card__photo" src={props.imageUrl} alt=""/>
       <div className="card__details">
          <div className="place">
            ...
            <a href={props.googleMapsUrl} className="card__map" target="_blank" rel="noreferrer">View on Google Maps</a>
          </div>
         <h2 className="card__title">{props.title}</h2>
         <span className="card__date">{props.startDate} - {props.endDate}</span>
